#define MyAppName "Toolbox2docker"
...
OutputBaseFilename=Toolbox2docker
Compression=lzma
...
begin
  dirpath := ExpandConstant('{userappdata}\Toolbox2docker');
...
begin
  ...
  WizardForm.StatusLabel.Caption := 'Upgrading Toolbox2docker VM...'
